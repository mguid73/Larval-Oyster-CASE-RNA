...
setwd("~/repos/Larval-Oyster-CASE-RNA/MG-GO-MWU")


# CA
################################################################
# Edit these to match your data file names: 
input="res_CA_comma.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).
goAnnotations="res_CA_GO" # two-column, tab-delimited, one line per gene, multiple GO terms separated by semicolon. If you have multiple lines per gene, use nrify_GOtable.pl prior to running this script.
goDatabase="go.obo" # download from http://www.geneontology.org/GO.downloads.ontology.shtml
goDivision="BP" # either MF, or BP, or CC -- we chose BP for biological processes, MF= molecular function and CC= Cellular component
