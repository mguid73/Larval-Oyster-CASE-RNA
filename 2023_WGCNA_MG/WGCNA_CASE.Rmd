...
count_data <- read.csv(file ="gene_count_matrix.csv", sep =',', header=TRUE)
...
png("/home/mguidry/wgcna_exercise/Day7_ClusterTree_Precut.png", 1000, 1000, pointsize=20)
...
png("/home/mguidry/wgcna_exercise/Day7_ClusterTree_Postcut.png", 1000, 1000, pointsize=20)
...
png("/home/mguidry/wgcna_exercise/Day7_ClusterTree_PrimaryTreatment.png", 1000, 1000, pointsize=20)
...
# Second treatment 
png("/home/mguidry/wgcna_exercise//Day7_ClusterTree_SecondTreatment.png", 1000, 1000, pointsize=20)
...
png("/home/mguidry/wgcna_exercise/Day7_ClusterTree_GroupTreatment.png", 1000, 1000, pointsize=20)
...
# save(dds.d7_vst, d7.Traits, file = "/home/mguidry/wgcna_exercise/d.7-dataInput.RData")
#write.csv(dds.d7_vst, "/home/mguidry/wgcna_exercise/Day7_vstTransformed_WGCNAdata.csv") # # write the vst transformed data 
...
sft = pickSoftThreshold(dds.d7_vst, powerVector = powers, verbose = 5) #...wait for this to finish (took ~2mins)
#  pickSoftThreshold 
...
png("/home/mguidry/wgcna_exercise/Day7_ScaleTopology_SoftThresh.png", 1000, 1000, pointsize=20)
        par(mfrow = c(1,2));
        cex1 = 0.9;
...
adjacency_unsign = adjacency(dds.d7_vst, power = softPower, type="unsigned") # this takes a long time.. just wait... (<5min)

# signed - must call te type, defaults to unsigned
adjacency_sign = adjacency(dds.d7_vst, power = softPower, type="signed") # this takes a long time.. just wait...(<5min)
...
# signed matrix
TOM_sign       = TOMsimilarity(adjacency_sign, TOMType="signed")  # this takes a long time.. just wait... (6min)
...
# Plot the result ================================================================ #
sizeGrWindow(7, 6)
png("/home/mguidry/wgcna_exercise/Day7_ClusterEigengenes.png", 1000, 1000, pointsize=20)
...
save(MEs, moduleLabels, moduleColors, file = "/home/mguidry/wgcna_exercise/Day7-networkConstruction-stepByStep.RData")
# write csv - save the module eigengenes
write.csv(MEs, file = "/home/mguidry/wgcna_exercise/d7.WGCNA_ModulEigengenes.csv")
...
png("/home/mguidry/wgcna_exercise/Day7_Treatments_Primary_heatmap2.png", 500, 1000, pointsize=20)
...
pdf("/home/mguidry/wgcna_exercise/Day7_Treatments_Primary_heatmap.pdf", width=5, height=6)
...
par(mar = c(8, 9.5, 5, 3));
# Display the correlation values within a heatmap plot
png("/home/mguidry/wgcna_exercise/Day7_Treatments_Second_heatmap2.png", 1000, 500, pointsize=20)
...
par(mar = c(8, 9.5, 5, 3));
# Display the correlation values within a heatmap plot
png("/home/mguidry/wgcna_exercise/Day7_Group_heatmap2.png", 1000, 500, pointsize=20)
...
#plot it
png("/home/mguidry/wgcna_exercise/Day7_ME_Boxplot.png", 600, 1000, pointsize=20)
